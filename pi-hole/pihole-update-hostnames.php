...
define('CONFIG', '/etc/dnsmasq.d/05-pihole-missing-hostnames.conf');
define('HOSTS', '/etc/pihole/missing-hostnames.list');
...
define('HOSTS_HEADER', '# This file is automatically generated by ' . __FILE__ . PHP_EOL . PHP_EOL);
...
if (!file_exists(CONFIG) && !file_put_contents(CONFIG, 'addn-hosts=' . HOSTS)) {
    echo "Failed to create config: " . CONFIG . PHP_EOL;
    exit(1);
}

if (!file_exists(HOSTS) && !file_put_contents(HOSTS, HOSTS_HEADER)) {
